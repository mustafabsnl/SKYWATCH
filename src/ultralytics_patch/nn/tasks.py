...
from ultralytics.nn.modules import (
    ...
    YOLOESegment26,
    v10Detect,
    C2f_CAM,  # SKYWATCH custom: Contextual Attention Module
    FRM,       # SKYWATCH custom: Feature Refinement Module
)
    ...
    base_modules = frozenset(
        {
            ...
            C2fCIB,
            A2C2f,
            C2f_CAM,  # SKYWATCH: Contextual Attention Module (same signature as C2f)
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2PSA,
            A2C2f,
            C2f_CAM,  # SKYWATCH: repeat support (same as C2f)
        }
    )
